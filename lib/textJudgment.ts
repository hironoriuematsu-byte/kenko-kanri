...
export const ECG_KEYWORDS: Keyword[] = [
  ...
  { word: "ブロック", grade: "C" },
  // --- B ---
  // 軽度のST-T異常は B(事務所の方針。長い語句から照合するため「ST-T異常」の D より先に一致する)
  { word: "軽度のst-t異常", grade: "B" },
  { word: "軽度st-t異常", grade: "B" },
  { word: "軽度のst-t変化", grade: "B" },
  { word: "軽度st-t変化", grade: "B" },
  { word: "軽度のst-t低下", grade: "B" },
  { word: "軽度st-t低下", grade: "B" },
  { word: "軽度のst異常", grade: "B" },
  { word: "軽度st異常", grade: "B" },
  { word: "軽度のst低下", grade: "B" },
  { word: "軽度st低下", grade: "B" },
  { word: "軽微なst-t異常", grade: "B" },
  { word: "軽微なst-t変化", grade: "B" },
